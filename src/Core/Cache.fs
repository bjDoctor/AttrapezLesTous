...
/// (This caching mechanism is very basic, not to be used in prod)
//////
...
/// Retrieves a value, identified by key, from a cache, if it exists,
/// or obtains data from an async fetch method and stores its result
